...
public class CustomerController {
	...
	public ResponseEntity<CustomerDetailDto> fetchCustomerDetails(@RequestParam @NotEmpty(message = "Account number cannot be null or empty") @Pattern(regexp = "^$|[0-9]{10}", message = "Account number must be 10 digits") String mobileNumber) {
